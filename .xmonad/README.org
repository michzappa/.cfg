...
#+begin_example
Prelude>
<interactive>:39:13-28: error:
    Variable not in scope: myLayoutsSpacing

<interactive>:39:30-32: error:
    • Variable not in scope: (|||) :: t0 -> t1 -> t
    • Perhaps you meant ‘||’ (imported from Prelude)

<interactive>:39:34-51: error:
    Variable not in scope: myLayoutsNoSpacing
#+end_example
