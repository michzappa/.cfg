...
* Defaults
Basic settings for my configuration and aspects of the default configuration.
#+BEGIN_SRC conf
set $mod Mod4
...
bindsym Ctrl+Mod1+k exec $HOME/.scripts/change_keyboard_layout.sh
#+END_SRC
